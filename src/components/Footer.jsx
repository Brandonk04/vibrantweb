      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-4 w-10/12 m-auto gap-8">
        <div className="">
          <div className="flex items-center">
            <img src="" alt="logo" />
            <h1 className="text-xl font-bold uppercase">VibrantWeb Solutions </h1>
          </div>

          <div className="">
            <p className="text-lg py-8">
              Copy right &copy; {year} VibrantWeb Solutions <br /> all rights reserved{" "}
            </p>
            <div className="flex items-center">
              <AiOutlineDribbble className="mx-2 cursor-pointer" href="https://dribbble.com/brandon-io/about" size={25} />
              <AiOutlineTwitter className="mx-2 " href="https://twitter.com/Brandonkatjitu3" size={25} />
              <AiOutlineInstagram className="mx-2 " href="https://www.instagram.com/brandon__io/" size={25} />
              <a href="https://youtube.com/@revolox6265?si=oAeZzxYxPqlT7YdE" target="blank">
        ...
        <div className="stay tune">
          <h1 className="text-xl font-bold uppercase">Stay Tuned </h1>
          <div className="py-8">
            <form
